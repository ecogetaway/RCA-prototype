<template>
    <Views :loading="loading" :error="error" :noTitle="noTitle">
        ...
        <div v-else-if="rca">
            ...
            <div v-if="rca.insights && rca.insights.length">
                <div class="mt-5 mb-3 text-h6"><v-icon color="blue">mdi-brain</v-icon> AI Agent Insights</div>
                <v-card outlined class="pa-3">
                    <ul>
                        <li v-for="insight in rca.insights" :key="insight">{{ insight }}</li>
                    </ul>
                </v-card>
            </div>
